...
<template>
  <el-date-picker
    ...
    :value-format="format"
    :disabled="disabled"
    :start-placeholder="startPlaceholder ? startPlaceholder : t('component.placeholder_select_date')"
    :end-placeholder="endPlaceholder ? endPlaceholder : t('component.placeholder_select_date')"
